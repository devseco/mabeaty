...
class Checkout_controller extends GetxController{
  ...
  void onInit() {
    ...
    namePage = sharedPreferences!.getString('pageName')!;
    update();
  ...
  Future<bool> addBill(phone,city,address,price,delivery,items,customer_name,customer_total,customer_nearpoint , profit , note ) async{
    ...
    var result = await RemoteServices.addBill(name_agent, phone, city, address, price, delivery, list , user_id ,customer_name , customer_total , customer_nearpoint , profit , note  , namePage);
